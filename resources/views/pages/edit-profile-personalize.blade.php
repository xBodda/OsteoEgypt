...
<form action="{{ route('save-edit-profile') }}" method="POST" enctype="multipart/form-data">
    <div class="flex">
        <div class="w-4/12 bg-white shadow mr-7 h-full">
            ...
            <a href="{{ route('edit-profile-personalize') }}"><div class="p-6 text-white bg-chillBlue cursor-pointer font-bold">Personalize</div></a>
        </div>
                ...
                {{-- Had yekhaley el sowar dynamic adoos yebadlhom --}}
                    ...
                    <div class="h-32 w-full grid grid-cols-5 grid-rows-1 gap-2">
                        <div class="w-full h-full bg-black float-left relative rounded-xl">
                            <img src="{{asset('assets/image/Cover1.png')}}" class=" h-full w-full object-cover object-center cursor-pointer  border-solid border-8 rounded-xl border-chgillBlue">
                        </div>
