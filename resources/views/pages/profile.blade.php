...
<div class="flex justify-start relative z-10">
    <div class="flex-initial -mt-72">
        <div class="w-80 shadow-lg">
            <div class="w-full p-4 bg-white border-0 border-b border-solid">
                ...
                <div class="mt-4">
                    <p class="text-xl font-black text-blueGray-dark">Mohamed Ashraf Ismail</p>
            ...
            <div class="w-full p-4 bg-white border-0 border-b border-solid">
                <div class="mb-3">
                    ...
                    <p class="text-lg text-blueGray-dark font-black">Example@example.com</p>
                </div>
                <div class="mb-3">
    ...
    <div class="flex-auto ml-6">
        <div class="w-full">
            ...
            <div class="flex w-full h-44 border border-solid border-gray-300 mt-3">
